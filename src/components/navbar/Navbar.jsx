    ...
    if (localStorage.getItem('user') !== null && localStorage.getItem('email') !== null && localStorage.getItem('name') !== null){
        ...
        <nav className = "navbar">
            ...
            <div className='middle'>
                <img src={`${process.env.PUBLIC_URL}/asset/image/weblogo.png`} alt=''></img>
            </div>
            <div className='last'>
                <div className='user'>
                <div className='logo'>{localStorage.getItem('name')[0]}</div>
        ...
        <nav className='side-nav' id='sidenav'>
            ...
            <div>
                ...
                <li onClick={()=>{navigate("/myblogs");chagedisp()}}>My Blogs</li>
                <hr className='main-h'/>
